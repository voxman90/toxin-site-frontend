...
Разработка ведется по принципу API-First. Фронтенд не описывает модели данных вручную, а использует готовые типы, автоматически поставляемые из бэкенд-репозитория.
